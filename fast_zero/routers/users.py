...
SessionLocal = Annotated[AsyncSession, Depends(get_session)]
CurrentUser = Annotated[User, Depends(get_current_user)]
CurrentId = Annotated[
    int, Path(..., description=description_current_user, examples=[1])
]
ItensSkip = Annotated[
    int,
...
async def create_user(user: UserSchema, session: SessionLocal):
